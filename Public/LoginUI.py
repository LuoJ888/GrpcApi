...
class MainUI(object):
    ...
    def __init__(self, geometrysize="350x250", geometry="+800+350"):
        ...
        self.username = tkinter.StringVar()  # 生成一个StringVar 对象，来保存下面输入框中的内容
    ...
    def select_path(self):
        ...
        self.username.set(path_)

    def create_widgets(self):
        """创建窗口中的各种元素"""
        # 账号
        first_label = tkinter.Label(self.top, text='账号：')  # 生成一个标签
        ...
        first_entry = tkinter.Entry(self.top, textvariable=self.username)
        ...
        # 登录按钮
        way_button = tkinter.Button(self.top, text="登录", command=self.get_value, bg='light blue')
